  ...
  <body>
      <div class="bs-component">
             <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
               <a class="navbar-brand" href="https://bootswatch.com/lux/#">iAssist</a>
               ...
               <div class="collapse navbar-collapse" id="navbarColor01">
                 <ul class="navbar-nav mr-auto">
                   <li class="nav-item active">
                     <a class="nav-link" href="https://bootswatch.com/lux/#">Home <span class="sr-only">(current)</span></a>
                   </li>
                   <li class="nav-item">
                     <a class="nav-link" href="https://bootswatch.com/lux/#">Profile</a>
                   </li>
                   <li class="nav-item">
                     <a class="nav-link" href="https://bootswatch.com/lux/#">Notification</a>
                   </li>
                   <li class="nav-item">
                     <a class="nav-link" href="https://bootswatch.com/lux/#">Settings</a>
                   </li>
                 </ul>
