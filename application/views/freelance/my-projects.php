...
<div class="row">
	...
	<?php foreach($data as $row):?>
		<div class="col-md-3" style="padding: 8px;">
			<div class="card">
			  <a href="<?php base_url()?>/iAssist/users/edit_projects/<?php echo $row->project_title_slug."0".$row->id?>"><img style="height: 250px; width: 100%; display: block;" src="<?php echo site_url("uploads/$row->project_image"); ?>" " alt="Card image">
			  	</a>
			  <div class="card-body" style="padding-top: 10px;">
			    <p class="card-text text-center" style="margin:2px;"><?php $date = $row->project_date_created; echo date("M j, Y, g:i",strtotime($date));?></p>
