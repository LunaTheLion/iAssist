...
<div id="page-wrapper" >
    <div id="page-inner"><div class="panel panel-primary no-bord<div class="panel-headin  All  < <div class="panel-body"><div class="table-responsive">
   <table class="table table-hover">
    	  <thead>
    	      <tr>
    	          <th>
    	              <i class="fa fa-lg fa-sort-a</i>
    	          </th>
    	          <th>
